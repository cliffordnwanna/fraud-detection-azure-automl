# This file has been autogenerated by version 1.59.0 of the Azure Automated Machine Learning SDK.
...
automl_run_id = 'fraud-detection-job_1'
...
def generate_data_transformation_config():
    ...
    column_group_0 = [['step'], ['amount'], ['oldbalanceOrg'], ['newbalanceOrig'], ['oldbalanceDest'], ['newbalanceDest']]
    
    column_group_2 = ['isFlaggedFraud']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_uri', type=str, default='azureml://locations/eastus2/workspaces/97c59552-68d1-4a45-995d-61951623df56/data/financial-transactions/versions/1',     help='Default training dataset uri is populated from the parent run')
